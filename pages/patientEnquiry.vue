    ...
    <div v-if="successMessage" class="success-message">{{ successMessage }}</div>
      ...
      <div class="top-line">
          <div class="line-1">
              ...
              <label>Gender
                  <label><input type="radio" v-model="data.gender" value="male"> Male</label>
                  <label><input type="radio" v-model="data.gender" value="female"> Female</label>
              </label>
          </div>
          <div class="line-2">
      ...
      <div class="top-line-1"  v-if="showAdditionalInfo">
          <div class="line-1">
              ...
              <label>Gender
                  <label><input type="radio" v-model="data.gender_0" value="male"> Male</label>
                  <label><input type="radio" v-model="data.gender_0" value="female"> Female</label>
              </label>
          </div>
          <div class="line-2">
      ...
      <div class="patient">
          <div class="line-4">
              <label>DoctorSelection
                  <label><input type="radio" v-model="data.doctorSelection" value="duty">DutyDoctor</label>
                  <label><input type="radio" v-model="data.doctorSelection" value="chief"> ChiefDoctor</label>
              </label>
          </div>
          <div class="line-5">
          ...
          <div class="line-6">
              <label for="remarks">Remarks</label>
              <textarea id="remarks" rows="4" class="custom-input" v-model="data.remarksDoc"></textarea>
          </div>
          <!-- expected date --follow update -->
          <div class="line-7">
              <label>Expected Date</label>
              <input type="date" id="expectedDate" v-model="data.expectedDate"  @input="validateDate('expectedDate')" :min="getMinDate()"/>
              <div v-if="dateWarnings.expectedDate" class="warning-message">{{ dateWarnings.expectedDate }}</div>

              <div class="follow-date">
              <label>Follow-up Date</label>
              <input type="date" id="followUpDate" v-model="data.followUpDate" @input="validateDate('followUpDate')" :min="getMinDate()"/>
